...
package cn.fibo.cdp.modules.oss.controller;
...
import cn.fibo.cdp.modules.oss.cloud.CloudStorageConfig;
import cn.fibo.cdp.modules.oss.cloud.OSSFactory;
...
public class SysOssController {
	...
	public R upload(@RequestParam("file") MultipartFile file) throws Exception {
		if (file.isEmpty()) {
			throw new CustomExceptionException("上传文件不能为空");
		}
