...
<template>
  <div class="event-table modular">
    <a-table :columns="columns" :data="data" :pagination="true" :loading="loading" :defaultExpandAllRows="false"
      :stripe="true" row-class="common-row" :scroll="scroll" :key="componentKey">
